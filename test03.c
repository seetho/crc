...
#include "CRC4_0x1_30_msb.lut"
};

const uint8_t lut_lsb[256] = {
#include "CRC4_0x1_30_lsb.lut"
};
...
int main(void) {
    ...
    printf("Test CRC-4/ITU G.704 GPoly 10011b msb-1st data.\n");
    ...
    crc = 0x00;
    printf("\nTest CRC-4/ITU G.704 GPoly 10011b lsb-1st data.\n");
